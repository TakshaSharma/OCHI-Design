...
function Footer() {
  return (
    <div className="w-full relative flex justify-between h-[110vh] bg-[#f4f4f4] px-14 rounded-t-3xl pt-24 pb-10">
      <div className=" w-1/2 h-full flex flex-col justify-between fonts">
        <div className="heading">
          <h1 className=" cursor-default text-[9vw] tracking-[-1px] uppercase leading-none text-[#212121]">
            Eye-
          </h1>
          <h1 className=" cursor-default text-[9vw] tracking-[-1px] uppercase leading-none text-[#212121] mt-[-2.5vw]">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className=" w-1/2 h-full flex flex-col fonts text-right">
        <h1 className="text-[9vw] cursor-default tracking-[-1px] uppercase leading-none text-[#212121]">
          presentations
        </h1>
        <div className="social-media flex flex-col">
          <h1 className="text-[5vw] cursor-default text-[#212121] tracking-[-1px] mt-14 mb-6">
            Social media
          </h1>
          <a
            href=" https://github.com/TakshaSharma"
            target="_blank"
            className="font2 text-xl ml-8 opacity-[.8]"
          >
            Github
          </a>
          <a
            href="https://www.linkedin.com/in/taksha-sharma/"
            target="_blank"
            className="font2 text-xl mt-3 ml-8 opacity-[.8]"
          >
            LinkedIn
          </a>
          <a
            href="mailto:taksha.sharma08@gmail.com"
            target="_blank"
            className="font2 text-xl mt-3 ml-8 opacity-[.8]"
          >
      ...
      <div className=" absolute right-0 text-right bottom-0 mb-10 flex flex-col font2 px-14">
        <div className=" opacity-[.8]">
          Note: This is a Replica of official ochi.design
        </div>
        <div className=" opacity-[.8]">
          I have just build this to Show Case my skills, & For Project Purpose.
        </div>
      </div>
    </div>
  );
