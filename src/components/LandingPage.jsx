              ...
              <div className="w-fit flex">
                {index === 1 && (
                  <motion.div
                    ...
                    className="w-[8.8vw] ml-1 mr-3 h-[5.75vw] rounded-2xl bg-red-500 mt-[.9vw] bg-[url('https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg')] bg-cover bg-center"
                  ></motion.div>
                )}
